...
<div >
    <form class="login" action="<?php echo URL.'login/iniciarSesion'; ?>" method="POST">
        <fieldset class="login__fieldset">
            <legend><h2>Inicia sesión</h2></legend>
            <label class="login__label" for="usuario">Nombre de usuario:</label>
            <input required class="login__input" type="text" name="usuario" id="usuario">
            <label class="login__label" for="password">Contraseña:</label>
            <input required class="login__input" type="password" name="password" id="password">
